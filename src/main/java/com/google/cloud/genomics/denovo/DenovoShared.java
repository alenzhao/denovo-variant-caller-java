...
public class DenovoShared {
  ...
  private DenovoShared(Builder builder) {
    ...
    allChromosomes = builder.allChromosomes;
  ...
  public static class Builder {
    ...
    private List<String> allChromosomes;
    ...
    public Builder chromosomes(List<String> chromosomes) {
      this.chromosomes = chromosomes;
      return this;
    }

    public Builder allChromosomes(List<String> allChromosomes) {
